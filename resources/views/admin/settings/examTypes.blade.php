...
@section('title') Exam Types @endsection
...
<nav aria-label="breadcrumb">
    ...
    <h3 class="font-weight-bolder mb-0"> Exam Types </h3>
</nav>
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="mb-0 text-sm"> {{ $examType['name'] }} </h6>
                                    </td>
                                    <td class="align-middle text-center text-sm">
                                        <span class="badge badge-sm bg-gradient-success"> {{ $examType['status'] == 1 ? 'Active' : 'Inactive' }} </span>
                                    </td>
                                    <td class="align-middle text-center text-sm">
                                        <button class="btn btn-secondary edit-exam-type" data-exam-type-id="{{ $examType['id'] }}" data-exam-type-name="{{ $examType['name'] }}">
                                            <i class="fa fa-edit"></i>
                                        </button>
                                        <button class="btn btn-danger remove-exam-type" data-exam-type-id="{{ $examType['id'] }}">
